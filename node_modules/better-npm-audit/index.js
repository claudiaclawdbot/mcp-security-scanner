 ...
 */
function callback(auditCommand, auditLevel, exceptionIds, modulesToIgnore, columnsToInclude) {
    ...
    if (audit.stderr) {
        audit.stderr.on('close', function () { return handleFinish_1.default(jsonBuffer, auditLevel, exceptionIds, modulesToIgnore, columnsToInclude); });
        // stderr
